...
function Gauge(gaugeElement, value, minValue, maxValue, onValue, warningValue, criticalValue, startAngle, stopAngle, pivotOffsetX, pivotOffsetY, pointerReach, continuous, imagePointer, imageOff, imageOn, imageWarning, imageCritical, onchanged)
{
	/* public properties */
	...
	this._init(value, minValue, maxValue, onValue, warningValue, criticalValue, startAngle, stopAngle, pivotOffsetX, pivotOffsetY, pointerReach,  imagePointer, imageOff, imageOn, imageWarning, imageCritical);
}
...
function CreateGauge(elementOrID, spec)
{
  	...
  	if (!gaugeElement.loaded) 
	{
		...
		gaugeElement.object = new Gauge(gaugeElement, spec.value || 0, spec.minValue || 0, spec.maxValue || 0, spec.onValue || 0, spec.warningValue || 0, spec.criticalValue || 0, spec.startAngle || 0, spec.stopAngle || 0, spec.pivotOffsetX || 0, spec.pivotOffsetY || 0, spec.pointerReach || 0, spec.continuous || false, spec.imagePointer || null, spec.imageOff || null, spec.imageOn || null, spec.imageWarning || null, spec.imageCritical || null, onchanged);
...
Gauge.prototype._init = function(value, minValue, maxValue, onValue, warningValue, criticalValue, startAngle, stopAngle, pivotOffsetX, pivotOffsetY, pointerReach, imagePointer, imageOff, imageOn, imageWarning, imageCritical)
{
